...
BASELINE_COMPANIES: List[CompanySuggestion] = [
    CompanySuggestion("Accenture", "accenture.com", "IE", "baseline"),
    CompanySuggestion("Adobe", "adobe.com", "US", "baseline"),
    CompanySuggestion("Alphabet", "abc.xyz", "US", "baseline"),
    CompanySuggestion("Amazon Web Services", "aws.amazon.com", "US", "baseline"),
    CompanySuggestion("Airbnb", "airbnb.com", "US", "baseline"),
    CompanySuggestion("Apple", "apple.com", "US", "baseline"),
    ...
    CompanySuggestion("Capital One", "capitalone.com", "US", "baseline"),
    CompanySuggestion("Citigroup", "citi.com", "US", "baseline"),
    ...
    CompanySuggestion("Facebook", "facebook.com", "US", "baseline"),
    CompanySuggestion("Fortech", "fortech.ro", "RO", "baseline"),
    CompanySuggestion("Figma", "figma.com", "US", "baseline"),
    CompanySuggestion("Goldman Sachs", "goldmansachs.com", "US", "baseline"),
    ...
    CompanySuggestion("JPMorgan Chase", "jpmorganchase.com", "US", "baseline"),
    ...
    CompanySuggestion("Morgan Stanley", "morganstanley.com", "US", "baseline"),
    ...
    CompanySuggestion("Robinhood", "robinhood.com", "US", "baseline"),
    ...
    CompanySuggestion("Snap Inc.", "snap.com", "US", "baseline"),
    ...
    CompanySuggestion("Visa", "visa.com", "US", "baseline"),
    CompanySuggestion("Vodafone", "vodafone.com", "GB", "baseline"),
    CompanySuggestion("Wells Fargo", "wellsfargo.com", "US", "baseline"),
